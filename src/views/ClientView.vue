<template>
    <main>
        <div>
            <table>
            <caption>Les clients - page {{ currentPage }} / {{ totalPages }} </caption>
                <tr>
                    <th>Code</th>
                    <th>Société</th>
                    <th>Contact</th>
                ...
                <tr>
                    <td class="pagination"><button @click="goToPage(1)" :disabled="currentPage === 1">⇇</button></td>
                    <td class="pagination"><button @click="goToPage(currentPage - 1)" :disabled="currentPage === 1">⟵</button></td>
                    <td class="pagination"><button @click="goToPage(currentPage + 1)" :disabled="currentPage === totalPages">⟶</button></td>
                    <td class="pagination"><button @click="goToPage(totalPages)" :disabled="currentPage === totalPages">⇉</button></td>
                </tr>
            </table>
        </div>
    </main>
